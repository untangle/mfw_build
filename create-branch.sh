...
REPOSITORIES="bctid bpfgen classd client-license-service mfw_admin mfw_build mfw_feeds mfw_schema mfw_ui nft_dict openwrt packetd reportd restd discoverd sync-settings ngfw_hades-pkgs"
